package dev.josycom.mayorjay.hellocompose
...
import dev.josycom.mayorjay.hellocompose.ui.theme.HelloComposeTheme
import dev.josycom.mayorjay.hellocompose.ui.theme.Shapes
...
fun OnboardingScreen(onContinueClicked: () -> Unit) {
    Surface {
        Column(
            ...
            Text("Welcome to Basic Jetpack Compose!")
            Button(
